...
<div class="container">
    ...
    <section class="hero">
        ...
        <p class="hero-text">
            NOVA는 VALORANT 플레이어가 자신의 게임 정보를
            확인하고 Discord 커뮤니티에서 티어를 인증할 수 있도록
            지원하기 위해 개발 중인 커뮤니티 서비스입니다.
        </p>
    ...
    <section class="cards">
        ...
        <div class="card">
            ...
            <p>
                플레이어의 VALORANT 경쟁전 정보를 확인하고
                Discord 서버에서 본인의 현재 티어를
                인증할 수 있도록 지원합니다.
            </p>
    ...
    <section class="verification">
        ...
        <p>
            실제 서비스에서는 Riot Games의 공식 인증 및
            API 이용 절차를 기반으로 플레이어의 게임 정보를
            확인할 예정입니다.
        </p>
    ...
    <section class="notice">
        ...
        <p>
            ...
            현재 단계에서는 Riot Games API의 실제 Production
            이용 승인을 전제로 기능을 설계하고 있으며,
            필요한 권한이 승인된 경우 공식 API 정책과
            개발자 약관을 준수하여 서비스를 운영할 예정입니다.
            <br><br>

            플레이어의 정보는 서비스 기능에 필요한 범위에서만
            사용하며, 불필요한 개인정보를 수집하거나
            저장하지 않는 것을 원칙으로 합니다.
        </p>
